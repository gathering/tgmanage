...
cvlc -I dummy -vvvv --decklink-audio-connection embedded --live-caching 3000 --decklink-aspect-ratio 16:9 --decklink-mode hp50 --decklink-video-connection sdi \
 ...
 -v decklink:// vlc://quit \
 --sout \
'#transcode{vcodec=h264,vb=5500,acodec=mp4a,ab=256,channels=2,fps=50}:duplicate{dst=std{access=http{metacube},mux=ts,dst=:5004/event.ts},dst=std{access=http{metacube},mux=ffmpeg{mux=flv},dst=:5004/event.flv}'
